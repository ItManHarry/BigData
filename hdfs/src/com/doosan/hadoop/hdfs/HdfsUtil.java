...
public class HdfsUtil {	
	...
	public void testMkdir() throws IllegalArgumentException, IOException{
		boolean exists = fs.exists(new Path("/data"));
		System.out.println("data directory exists ?" + (exists ? "Yes" : "No"));
		if(exists){
			System.out.println("data directory exists...");
		}else{
			System.out.println("data directory doesn't exist, do create ...");
			fs.mkdirs(new Path("/data"));
		}
		System.out.println("update a file to the data ...");
		fs.copyFromLocalFile(new Path("D:\\Github\\BigData\\code\\MapReduce\\worlds.txt"), new Path("/data"));
	...
	public void testRmdir() throws IllegalArgumentException, IOException{
		System.out.println("Now we are going to delete the data out file...");
		Path path = new Path("/data/out");
		fs.delete(path, true);
		boolean es = fs.exists(path);
		if(es){
			System.out.println("The data out file deleted failed...");
		}else{
			System.out.println("The data out file deleted successfully...");
		}
		fs.close();
	}
	/**
